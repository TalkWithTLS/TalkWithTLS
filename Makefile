...
S_SERVER_OSSL_111_OBJ=$(addprefix $(OBJ_DIR)/,$(S_SERVER_SRC:.c=$(OSSL_111_SUFFIX).o))
S_SERVER_OSSL_MASTER_OBJ=$(addprefix $(OBJ_DIR)/,$(S_SERVER_SRC:.c=$(OSSL_MASTER_SUFFIX).o))
S_TIME_OSSL_111_OBJ=$(addprefix $(OBJ_DIR)/,$(S_TIME_SRC:.c=$(OSSL_111_SUFFIX).o))
S_TIME_OSSL_MASTER_OBJ=$(addprefix $(OBJ_DIR)/,$(S_TIME_SRC:.c=$(OSSL_MASTER_SUFFIX).o))
