...
S_SERVER_OSSL_111 = $(PERF_BIN_DIR)/$(S_SERVER)$(OSSL_111_SUFFIX)
S_TIME_OSSL_111 = $(PERF_BIN_DIR)/$(S_TIME)$(OSSL_111_SUFFIX)
S_SERVER_OSSL_MASTER = $(PERF_BIN_DIR)/$(S_SERVER)$(OSSL_MASTER_SUFFIX)
S_TIME_OSSL_MASTER = $(PERF_BIN_DIR)/$(S_TIME)$(OSSL_MASTER_SUFFIX)

PERF_BIN = $(SPEED_OSSL_111) \
		   $(SPEED_OSSL_MASTER) \
		   $(S_SERVER_OSSL_111) \
		   $(S_TIME_OSSL_111) \
		   $(S_SERVER_OSSL_MASTER) \
		   $(S_TIME_OSSL_MASTER)
...
S_SERVER_OSSL_111_OBJ=$(addprefix $(OBJ_DIR)/,$(S_SERVER_SRC:.c=$(OSSL_111_SUFFIX).o)) $(COMM_OBJ)
S_SERVER_OSSL_MASTER_OBJ=$(addprefix $(OBJ_DIR)/,$(S_SERVER_SRC:.c=$(OSSL_MASTER_SUFFIX).o)) $(COMM_OBJ)
S_TIME_OSSL_111_OBJ=$(addprefix $(OBJ_DIR)/,$(S_TIME_SRC:.c=$(OSSL_111_SUFFIX).o)) $(COMM_OBJ)
S_TIME_OSSL_MASTER_OBJ=$(addprefix $(OBJ_DIR)/,$(S_TIME_SRC:.c=$(OSSL_MASTER_SUFFIX).o)) $(COMM_OBJ)
...
OSSL_111_CFLAGS = $(CFLAGS_DBG) -I $(OPENSSL_1_1_1_DIR)/include -DWITH_OSSL_111
OSSL_MASTER_CFLAGS = $(CFLAGS_DBG) -I $(OSSL_MASTER_DIR)/include -DWITH_OSSL_MASTER
...
OSSL_SAMPLE_DEPENDENCY=$(OSSL_111_LIBS)

# Sample Binaries
$(SAMPLE_BIN_DIR)/$(OPENSSL_SAMPLE_NB_CLNT):$(OPENSSL_SAMPLE_NB_CLNT_OBJ) $(OSSL_SAMPLE_DEPENDENCY)
	$(CC) $^ $(OSSL_111_LDFLAGS) -o $@
	@echo ""

$(SAMPLE_BIN_DIR)/$(OPENSSL_SAMPLE_NB_SERV):$(OPENSSL_SAMPLE_NB_SERV_OBJ) $(OSSL_SAMPLE_DEPENDENCY)
	$(CC) $^ $(OSSL_111_LDFLAGS) -o $@
	@echo ""

$(SAMPLE_BIN_DIR)/$(OPENSSL_D12_CLNT):$(OPENSSL_D12_CLNT_OBJ) $(OSSL_SAMPLE_DEPENDENCY)
	$(CC) $^ $(OSSL_111_LDFLAGS) -o $@
	@echo ""

$(SAMPLE_BIN_DIR)/$(OPENSSL_D12_NB_SERV):$(OPENSSL_D12_NB_SERV_OBJ) $(OSSL_SAMPLE_DEPENDENCY)
	$(CC) $^ $(OSSL_111_LDFLAGS) -o $@
	@echo ""

$(SAMPLE_BIN_DIR)/$(OPENSSL_D12_NB_CLNT):$(OPENSSL_D12_NB_CLNT_OBJ) $(OSSL_SAMPLE_DEPENDENCY)
	$(CC) $^ $(OSSL_111_LDFLAGS) -o $@
	@echo ""

$(SAMPLE_BIN_DIR)/$(OPENSSL_D12_SERV):$(OPENSSL_D12_SERV_OBJ) $(OSSL_SAMPLE_DEPENDENCY)
	$(CC) $^ $(OSSL_111_LDFLAGS) -o $@
	@echo ""

$(SAMPLE_BIN_DIR)/$(OPENSSL_D12_CUSTOM_BIO_CLNT):$(OPENSSL_D12_CUSTOM_BIO_CLNT_OBJ) \
						$(OSSL_SAMPLE_DEPENDENCY)
	$(CC) $^ $(OSSL_111_LDFLAGS) -o $@
	@echo ""
...
$(SAMPLE_BIN_DIR)/$(OPENSSL_T13_SERV_DHE):$(OPENSSL_T13_SERV_DHE_OBJ) $(OSSL_SAMPLE_DEPENDENCY)
	$(CC) $^ $(OSSL_111_LDFLAGS) -o $@
	@echo ""

$(SAMPLE_BIN_DIR)/$(OPENSSL_T13_CLNT_DHE):$(OPENSSL_T13_CLNT_DHE_OBJ) $(OSSL_SAMPLE_DEPENDENCY)
	$(CC) $^ $(OSSL_111_LDFLAGS) -o $@
	@echo ""

$(SAMPLE_BIN_DIR)/$(OPENSSL_T13_CLNT):$(OPENSSL_T13_CLNT_OBJ) $(OSSL_SAMPLE_DEPENDENCY)
	$(CC) $^ $(OSSL_111_LDFLAGS) -o $@
	@echo ""

$(SAMPLE_BIN_DIR)/$(OPENSSL_T13_SERV):$(OPENSSL_T13_SERV_OBJ) $(OSSL_SAMPLE_DEPENDENCY)
	$(CC) $^ $(OSSL_111_LDFLAGS) -o $@
	@echo ""
...
$(SAMPLE_BIN_DIR)/$(OPENSSL_T12_CLNT):$(OPENSSL_T12_CLNT_OBJ) $(OSSL_SAMPLE_DEPENDENCY)
	$(CC) $^ $(OSSL_111_LDFLAGS) -o $@
	@echo ""

$(SAMPLE_BIN_DIR)/$(OPENSSL_T12_SERV):$(OPENSSL_T12_SERV_OBJ) $(OSSL_SAMPLE_DEPENDENCY)
	$(CC) $^ $(OSSL_111_LDFLAGS) -o $@
	@echo ""
...
$(SAMPLE_BIN_DIR)/$(WOLFSSL_T13_SERV_SAMPLE):$(WOLFSSL_T13_SERV_SAMPLE_OBJ) $(WOLFSSL_LIBS)
	$(CC) $^ $(WOLFSSL_LDFLAGS) -o $@
	@echo ""

$(SAMPLE_BIN_DIR)/$(WOLFSSL_T13_CLNT_SAMPLE):$(WOLFSSL_T13_CLNT_SAMPLE_OBJ) $(WOLFSSL_LIBS)
	$(CC) $^ $(WOLFSSL_LDFLAGS) -o $@
	@echo ""
...
$(S_SERVER_OSSL_111):$(S_SERVER_OSSL_111_OBJ) $(OSSL_111_LIBS)
	$(CC) $(S_SERVER_OSSL_111_OBJ) $(OSSL_111_LDFLAGS) -o $@
	@echo ""

$(S_TIME_OSSL_111):$(S_TIME_OSSL_111_OBJ) $(OSSL_111_LIBS)
	$(CC) $(S_TIME_OSSL_111_OBJ) $(OSSL_111_LDFLAGS) -o $@
	@echo ""

$(S_SERVER_OSSL_MASTER):$(S_SERVER_OSSL_MASTER_OBJ) $(OSSL_MASTER_LIBS)
	$(CC) $(S_SERVER_OSSL_MASTER_OBJ) $(OSSL_MASTER_LDFLAGS) -o $@
	@echo ""

$(S_TIME_OSSL_MASTER):$(S_TIME_OSSL_MASTER_OBJ) $(OSSL_MASTER_LIBS)
	$(CC) $(S_TIME_OSSL_MASTER_OBJ) $(OSSL_MASTER_LDFLAGS) -o $@
	@echo ""
